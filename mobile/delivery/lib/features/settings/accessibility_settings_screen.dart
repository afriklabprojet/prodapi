        ...
        children: [
          ...
          _buildCard([
            _buildSliderTile(
              ...
              onChanged: (value) {
                ref.read(accessibilityProvider.notifier).setTextScaleFactor(value);
              },
              theme: theme,
            ),
          ], theme),
          ...
          _buildSectionHeader('Lecteur d\'écran', Icons.record_voice_over, theme),
          const SizedBox(height: 12),
          _buildCard([
            ListTile(
              leading: Container(
              ...
              trailing: Icon(
                state.screenReaderEnabled ? Icons.check_circle : Icons.info_outline,
                color: state.screenReaderEnabled ? Colors.green : Colors.grey,
              ),
            ),
          ], theme),
    ...
    return Semantics(
      ...
      child: SwitchListTile(
        secondary: Container(
          padding: const EdgeInsets.all(8),
          decoration: BoxDecoration(
            color: (value ? theme.primaryColor : Colors.grey).withValues(alpha: 0.1),
            shape: BoxShape.circle,
          ),
          child: Icon(
            icon,
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Text(formatValue(min), style: TextStyle(color: theme.hintColor, fontSize: 12)),
              Text(formatValue(max), style: TextStyle(color: theme.hintColor, fontSize: 12)),
            ],
          ),
        ],
      ),
              ...
              Expanded(
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: state.highContrast ? Colors.white : theme.primaryColor,
                    foregroundColor: state.highContrast ? Colors.black : Colors.white,
                    disabledBackgroundColor: state.highContrast ? Colors.white : theme.primaryColor,
                    disabledForegroundColor: state.highContrast ? Colors.black : Colors.white,
                  ),
                  child: Text(
                    'Bouton',
                    style: TextStyle(
              ...
              Expanded(
                child: OutlinedButton(
                  ...
                  style: OutlinedButton.styleFrom(
                    ...
                    disabledForegroundColor: state.highContrast ? Colors.white70 : null,
