...
class HomeWidgetSettingsScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<HomeWidgetSettingsScreen> createState() => _HomeWidgetSettingsScreenState();
}

class _HomeWidgetSettingsScreenState extends ConsumerState<HomeWidgetSettingsScreen> {
  @override
          ...
          IconButton(
            ...
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(content: Text('Widget actualisé')),
              );
            },
          ...
          Row(
            children: [
              ...
              Container(
                ...
                child: Icon(Icons.local_pharmacy, size: 18, color: primaryColor),
              ),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.local_shipping, size: 14, color: primaryColor),
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      fontSize: 11,
                      fontWeight: FontWeight.bold,
                      color: state.goalProgress >= 1.0 ? Colors.green : primaryColor,
                    ),
                  ),
                ],
              ),
    ...
    return RadioGroup<WidgetStyle>(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          ...WidgetStyle.values.map((style) => _buildStyleOption(
            style: style,
      ...
      children: [
        ...
        Card(
          child: SwitchListTile(
            ...
            onChanged: (value) {
              ref.read(advancedHomeWidgetProvider.notifier).setShowEarnings(value);
            },
          ),
        ),
      ],
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Slider(
                        ...
                        onChanged: (value) {
                          ref.read(advancedHomeWidgetProvider.notifier)
