...
class Tutorials {
  static const welcome = [
    TutorialStep(
      ...
      description:
          'Cette application vous permet de livrer des médicaments depuis les pharmacies partenaires jusqu\'aux clients.',
      icon: Icons.waving_hand,
    ),
    TutorialStep(
      title: 'Passez en ligne',
      description:
          'Cliquez sur le bouton "Passer en ligne" pour commencer à recevoir des commandes.',
    ...
    TutorialStep(
      ...
      description:
          'Quand une commande arrive, vous aurez quelques secondes pour l\'accepter. Ne ratez pas vos opportunités !',
      icon: Icons.notifications_active,
    ),
    TutorialStep(
      title: 'Gagnez de l\'argent',
      description:
          'Vos gains sont versés par la pharmacie. Une commission est déduite de votre wallet à chaque livraison.',
  ...
  static const acceptDelivery = [
    TutorialStep(
      ...
      description:
          'Une carte apparaît avec les détails : pharmacie, destination et montant estimé.',
      icon: Icons.delivery_dining,
    ),
    TutorialStep(
      title: 'Vérifiez les détails',
      description:
          'Distance totale, temps estimé et commission sont affichés. Évaluez si la course vous convient.',
      icon: Icons.info_outline,
    ),
    TutorialStep(
      title: 'Accepter ou refuser',
      description:
          'Glissez vers la droite pour accepter, ou attendez que le temps expire pour passer.',
      icon: Icons.swipe,
      actionLabel: 'Compris !',
    ),
  ];
  ...
  static const navigation = [
    TutorialStep(
      ...
      description:
          'La carte affiche votre itinéraire vers la pharmacie, puis vers le client.',
      icon: Icons.map,
    ),
    TutorialStep(
    ...
    TutorialStep(
      ...
      description:
          'Appuyez sur le bouton GPS pour ouvrir l\'itinéraire dans Google Maps ou Waze.',
  ...
  static const completeDelivery = [
    TutorialStep(
      ...
      description:
          'À la pharmacie, vérifiez la commande et confirmez le retrait.',
    ...
    TutorialStep(
      ...
      description:
          'Prenez une photo et/ou récupérez une signature pour confirmer la livraison.',
    ...
    TutorialStep(
      ...
      description:
          'Confirmez la livraison pour finaliser la course. Vos gains sont crédités automatiquement.',
  ...
  static const wallet = [
    TutorialStep(
      ...
      description:
          'Tous vos gains sont stockés ici. Consultez votre solde à tout moment.',
      icon: Icons.account_balance_wallet,
    ),
    TutorialStep(
      title: 'Historique des transactions',
      description:
          'Chaque livraison, bonus ou retrait est enregistré avec les détails.',
      icon: Icons.history,
    ),
    TutorialStep(
      title: 'Retrait d\'argent',
      description:
          'Demandez un retrait vers votre compte Mobile Money ou bancaire.',
      icon: Icons.payments,
    ...
    TutorialStep(
      ...
      description:
          'Générez un rapport CSV ou PDF de vos gains pour votre comptabilité.',
      icon: Icons.download,
      actionLabel: 'Compris !',
    ),
  ];
  ...
  static const offlineMode = [
    TutorialStep(
      ...
      description:
          'Pas de réseau ? L\'app continue de fonctionner avec les données en cache.',
      icon: Icons.cloud_off,
    ),
    TutorialStep(
      title: 'Synchronisation',
      description:
          'Vos actions sont sauvegardées et envoyées dès que la connexion revient.',
      icon: Icons.sync,
    ),
    TutorialStep(
      title: 'Données disponibles',
      description:
          'Vos livraisons actives, solde et profil restent accessibles.',
      icon: Icons.storage,
      actionLabel: 'OK !',
    ),
  ];
  ...
  static List<TutorialStep> getSteps(TutorialType type) {
    switch (type) {
      case TutorialType.welcome:
        return welcome;
      case TutorialType.acceptDelivery:
        return acceptDelivery;
      case TutorialType.navigation:
        return navigation;
      case TutorialType.completeDelivery:
        return completeDelivery;
      case TutorialType.wallet:
        return wallet;
      case TutorialType.challenges:
        return challenges;
      case TutorialType.offlineMode:
        return offlineMode;
    }
  }
}
...
final tutorialCompletedProvider = FutureProvider.family<bool, TutorialType>((
  ref,
  type,
) async {
