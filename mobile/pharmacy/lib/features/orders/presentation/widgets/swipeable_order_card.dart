...
class _SwipeableOrderCardState extends State<SwipeableOrderCard>
  ...
  Widget build(BuildContext context) {
    ...
    final statusLabel = orderStatus.localizedLabel;
...
class _StatusBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String label = orderStatus.localizedLabel;
...
class _OrderFiltersWidgetState extends State<OrderFiltersWidget> {
  ...
  List<Map<String, dynamic>> get _statuses => [
    {'value': null, 'label': 'Toutes', 'icon': Icons.all_inclusive},
    {'value': 'pending', 'label': OrderStatus.pending.displayLabel, 'icon': Icons.access_time},
    {'value': 'confirmed', 'label': OrderStatus.confirmed.displayLabel, 'icon': Icons.thumb_up},
    {'value': 'ready', 'label': OrderStatus.ready.displayLabel, 'icon': Icons.inventory_2},
    {'value': 'delivered', 'label': OrderStatus.delivered.displayLabel, 'icon': Icons.check_circle},
    {'value': 'cancelled', 'label': OrderStatus.cancelled.displayLabel, 'icon': Icons.cancel},
  ];
          ...
          Row(
            children: [
              _StatusCountCard(
                ...
                label: OrderStatus.pending.displayLabel,
              ...
              _StatusCountCard(
                ...
                label: OrderStatus.ready.displayLabel,
              ...
              _StatusCountCard(
                icon: Icons.check_circle,
                label: OrderStatus.delivered.displayLabel,
